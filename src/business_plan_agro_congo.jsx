...
const data = {
  horizon1: {
    ...
    investissements: [
      ...
      { poste: "Groupe électrogène 5 kVA", montant: 650000 },
      ...
      { poste: "Fonds de roulement initial (3 mois)", montant: 1200000 },
    ],
    chargesAnnuelles: [
      { poste: "Poussins (500/bande × 5 bandes)", montant: 1250000 },
      { poste: "Poulettes pondeuses (200)", montant: 600000 },
      { poste: "Aliment volaille (chair + pondeuses)", montant: 2800000 },
      { poste: "Vaccins & vétérinaire", montant: 350000 },
      { poste: "Main d'œuvre (1 ouvrier permanent)", montant: 900000 },
      { poste: "Carburant groupe électrogène", montant: 480000 },
      { poste: "Intrants agricoles (maïs)", montant: 300000 },
      { poste: "Transport & commercialisation", montant: 400000 },
      { poste: "Divers & imprévus (10%)", montant: 708000 },
    ],
    revenus: [
      { source: "Vente poulets de chair (2 300 kg/an × 2 500 FCFA/kg)", montant: 5750000 },
      { source: "Vente œufs (54 000 œufs/an × 125 FCFA)", montant: 6750000 },
      { source: "Vente maïs (3 t × 200 000 FCFA/t)", montant: 600000 },
    ],
  },
  horizon2: {
    ...
    chargesAnnuelles: [
      ...
      { poste: "Énergie & carburant", montant: 3000000 },
    ...
    revenus: [
      { source: "Vente poulets de chair (23 000 kg/an × 2 500 FCFA/kg)", montant: 57500000 },
      { source: "Vente œufs (540 000 œufs/an × 125 FCFA)", montant: 67500000 },
      { source: "Vente maïs + soja surplus (30 t)", montant: 6000000 },
    ],
  },
  horizon3: {
    ...
    chargesAnnuelles: [
      ...
      { poste: "Énergie & carburant", montant: 12000000 },
    ...
    revenus: [
      { source: "Vente poulets de chair (92 000 kg/an × 2 800 FCFA/kg)", montant: 257600000 },
      { source: "Vente œufs (2 700 000 œufs/an × 130 FCFA)", montant: 351000000 },
      { source: "Vente maïs + soja surplus (200 t)", montant: 40000000 },
      { source: "Abattage à façon (service tiers)", montant: 15000000 },
    ],
  },
};
