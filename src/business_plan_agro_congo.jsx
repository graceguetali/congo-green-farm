...
const data = {
  horizon1: {
    ...
    chargesAnnuelles: [
      ...
      { poste: "Entretien système solaire (annuel)", montant: 120000 },
      { poste: "Intrants agricoles (maïs)", montant: 300000 },
      { poste: "Transport & commercialisation", montant: 400000 },
      { poste: "Divers & imprévus (10%)", montant: 537000 },
    ],
    revenus: [
      { source: "Vente poulets de chair (23 lots de 50 × 275 000 FCFA/lot)", montant: 5750000 },
      { source: "Vente œufs (1 800 cageots de 30 × 3 750 FCFA/cageot)", montant: 6750000 },
  ...
  horizon2: {
    ...
    revenus: [
      { source: "Vente poulets de chair (230 lots de 50 × 250 000 FCFA/lot)", montant: 57500000 },
      { source: "Vente œufs (18 000 cageots de 30 × 3 750 FCFA/cageot)", montant: 67500000 },
  ...
  horizon3: {
    ...
    revenus: [
      { source: "Vente poulets de chair (920 lots de 50 × 280 000 FCFA/lot)", montant: 257600000 },
      { source: "Vente œufs (90 000 cageots de 30 × 3 900 FCFA/cageot)", montant: 351000000 },
